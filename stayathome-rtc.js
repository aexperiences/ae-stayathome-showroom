/* mca-rtc.js — Cedar Hollow Home Care (AEHub) NATIVE video conferencing (own WebRTC, no third party)
   ------------------------------------------------------------------------
...
(function () {
  ...
  var API = (window.STAYATHOME_API||'https://ae-connect-api.vercel.app')+'/api/connect';
  ...
  window.StayAtHomeMeet = ESPOAPI; window.MCAMeet = ESPOAPI; window.ESPOMeet = ESPOAPI; window.LCPMeet = ESPOAPI;
})();
