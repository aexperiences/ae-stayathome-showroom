/* ============================================================================
   STAY@HOME OS — OWNER'S MANUAL PANEL
...
(function (global) {
  "use strict";
  if (!global.StayAtHome) return;
  var S = global.StayAtHome;
  ...
  function build() {
    ...
    panel.innerHTML =
      ...
      '<div class="man-ask"><input id="manQ" placeholder="Ask a question — e.g. why is overtime a margin problem?" autocomplete="off">' +
